...
class ReaderTest {
    ...
    @Test
    void staticTest(){
        assertEquals(0, Reader.CARD_NUMBER_);
        assertEquals(1, Reader.NAME_);
        assertEquals(2, Reader.PHONE_);
        assertEquals(3, Reader.BOOK_COUNT_);
        assertEquals(4, Reader.BOOK_START_);
    }
